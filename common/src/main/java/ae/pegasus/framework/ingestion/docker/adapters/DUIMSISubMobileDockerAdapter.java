...
public class DUIMSISubMobileDockerAdapter implements IDockerAdapter {
    ...
    public ContainerConfig getContainerConfig(String recordsCount) {
        return dockerImage.getConfig("-n", recordsCount, "origin/D/Du-IMSI-To-Subscriber-mobile-simulation.json");
    }
