...
public class DUIMSISubEnterpriseDockerAdapter implements IDockerAdapter {
    ...
    public ContainerConfig getContainerConfig(String recordsCount) {
        return dockerImage.getConfig("-n", recordsCount, "origin/D/Du-IMSI-To-Subscriber-enterprise-simulation.json");
    }
