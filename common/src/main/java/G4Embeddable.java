...
public class G4Embeddable extends CustomStories {

    private static AllureReporter reporter;

    G4Embeddable(AllureReporter reporter) {
        G4Embeddable.reporter = reporter;
