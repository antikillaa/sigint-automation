...
public class ObjectInitializer {
    ...
    public List<Object> generateObjects(Class<?> classType, int collectionSize) {
        ArrayList<Object> objectsList = new ArrayList<>();
        for (int i=1; i<=collectionSize; i++) {
            objectsList.add(generateObject(classType));
        }
        return objectsList;
    }
    ...
    private class DataGenerator {
        ...
        private Object generateValue() {
            ...
            if (dataType.isCollection()) {
                ...
                dataType.getCollectionDataType().cast(collection);
                return collection;
            }
        ...
        private Object generateSingleData() {
            ...
            if (provider == null) {
                ...
                value = generateObject(classType);
                return value;
            }
            return provider.generate(field.getDataSize().getDataLength());
        }
    }
