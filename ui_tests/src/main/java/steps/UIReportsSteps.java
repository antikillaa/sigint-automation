...
import controllers.ReportAddController;
...
public class UIReportsSteps extends UISteps {
    ...
    private ReportAddController addController = new ReportAddController();
    ...
    public void pressSubmitButton() {
        pages.reportsCreatePage().getActionBar().clickSubmitButton();
    }
    ...
    public void fillOutRequiredFieldsOnCreateManualReportPage() {
        ...
        report
                ...
                .setSourceType(RandomGenerator.getRandomItemFromList(context.getDictionary().getSourceTypes()).getType());

        Report tableReport = addController.fillForm(report);
        context.put("report", report);
    }
    ...
    public void shouldSeeRemoveOwnershipButtonOnEditReportPage(){
        pages.reportsEditPage().getActionBar().getRemoveOwnership().shouldBe(visible);
    }

    @When("I press 'Remove Ownership' button on 'Edit Report' page")
    public void pressRemoveOwnershipButton() {
        page(ReportActionBar.class).clickRemoveOwnership();
    }
    ...
    public void pressTakeOwnershipButtonOnEditReportPage() {
        pages.reportsEditPage().getActionBar().clickTakeOwnershipButton();
    }
    ...
    public void requiredButtonsAreEnabledOnEditReportPage() {
        pages.reportsEditPage().getActionBar().getRefreshButton().shouldBe(enabled);
        pages.reportsEditPage().getActionBar().getRemoveOwnership().shouldBe(enabled);
        pages.reportsEditPage().getActionBar().getSubmitButton().shouldBe(enabled);
        pages.reportsEditPage().getActionBar().getSaveDraftButton().shouldBe(enabled);
    }
