...
public class UIRequestForInformationActionsSteps {
    ...
    public void iStartSendingRequest() {
        Pages.updateRequestForInformationPage().performAction(ReportAndRequestAction.SEND);
    }
    ...
    public void iRecallRequest() {
        Pages.updateRequestForInformationPage().performAction(ReportAndRequestAction.RECALL);
    }
}
