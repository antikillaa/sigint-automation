...
public class UIVerifyOperatorReportFieldsSteps {
    ...
    public void iShouldSeeClassification(String classification) {
        checkSingleValue(ReportAndRequestField.CLASSIFICATION, classification, "Classification in operator report");
    }
    ...
    public void iShouldSeeSubject(String subject) {
        checkSingleValue(ReportAndRequestField.SUBJECT, subject, "Subject in operator report");
    }
    ...
    public void iShouldSeeNotes(ExamplesTable notesLines) {
        checkSingleValue(ReportAndRequestField.NOTES, convertToString(notesLines), "Notes in operator report");
    }
