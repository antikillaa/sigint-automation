...
class RecordsManager(Manager):
    ...
    def to_request(self, obj=None, **kwargs):
        ...
        new_obj.manualEntry = obj.manualEntry or ""
        ...
        new_obj.sourceId = self.context.sources.get_source_id(obj.sourceId) or \
                           self.context.sources.get_source_id(select_random_item(RecordData.sources))
